...
export default function SecondaryButton() {
  return (
    <div className="flex flex-row-reverse space-x-4 space-x-reverse">
      <a href="#" className="text-[var(--secondary-color)] flex w-fit mb-10 gap-2 outline hover:outline-[3px] p-2 px-4 outline-[var(--accent-color)] hover:text-[var(--accent-color)] md:p-2 md:text-[20px] md:px-8">
