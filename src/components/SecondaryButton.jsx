...
export default function SecondaryButton() {
  return (
    <a href="#" className="text-[var(--secondary-color)] w-fit place-content-end mt-3 flex gap-2 border hover:border-[3px] p-2 px-4 border-[var(--accent-color)] hover:text-[var(--accent-color)] md:p-2 md:text-[20px] md:px-8">
