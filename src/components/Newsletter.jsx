  ...
  return (
    <div className="grid ml-auto mr-auto place-items-center md:grid-rows-2 md:w-[395px]">
      ...
      <label className="flex mt-1 md:place-self-end" htmlFor="newsletter">
        <input className="outline-2 outline-[var(--accent-color)] bg-[var(--primary-color)] p-2 text-[--secondary-color] md:w-[275px]" id="newsletter" name="newsletter" type="text" placeholder="YOUR EMAIL ADRESS" />
